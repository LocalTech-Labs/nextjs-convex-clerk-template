...
- **Template updates**: Run the `/template-sync` slash command (Cursor/Claude Code) and follow `docs/template-sync.md` for step-by-step approval before applying template changes.
